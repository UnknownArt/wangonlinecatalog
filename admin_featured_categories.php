          ...
          ?>
            ...
            <main>
                <div class="main-content">
                    <div class="container">
                        <h2 class="page-title">Recommended Categories Settings</h2>
                        <?php
                        if(isset($_GET['update_result'])){
                            if ($_GET['update_result'] == true) {
                                echoAlert("success", "Success!", "Recommended Categories Updated!");
                            }
                            else {
                                echoAlert("danger", "Error!", "Failed to update Recommended Categories!");
                            }
                        }
                        ?>
                        ...
                        <form action="admin/update_featured_categories.php" method="post">
                            <div class="form-group">
                                <label for="featuredCat1">Recommended Category 1:</label>
                            ...
                            <div class="form-group">
                                <label for="featuredCat2">Recommended Category 2:</label>
                            ...
                            <div class="form-group">
                                <label for="featuredCat3">Recommended Category 3:</label>
                            ...
                            <div class="form-group">
                                <label for="featuredCat4">Recommended Category 4:</label>
