...
<head>
  ...
  <meta name="description" content="Internetowy Product Catalog" />
  <meta name="keywords" content="katalog, Products, online" />
                ...
                <form class="form-inline" method="get" action="products.php?cat_id=<?php echo $cat_id; ?>">
                  ...
                  <div class="form-group mb-2">
                    ...
                    <select class="custom-select filters-select" name="srt">
                      <option value="new" <?php if($sort_type=="new") echo "selected"; ?>>From newest</option>
                      <option value="pasc" <?php if($sort_type=="pasc") echo "selected"; ?>>By price ascending</option>
                      <option value="pdesc" <?php if($sort_type=="pdesc") echo "selected"; ?>>By price descending</option>
                      <option value="az" <?php if($sort_type=="az") echo "selected"; ?>>Alphabetically A-Z</option>
                      <option value="za" <?php if($sort_type=="za") echo "selected"; ?>>Alphabetically Z-A</option>
                    </select>
                  </div>
                  <div class="form-group mx-md-3 mb-2">
                    <label for="showItemsNum">Show on page:</label>
