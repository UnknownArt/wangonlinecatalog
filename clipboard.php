                        ...
                        <?php
                            if(isset($_GET['del_result'])){
                                    if($_GET['del_result'] == true){
                                        echoAlert("success", "Success!", "The product has been removed from the clipboard!");
                                    }
                                    else{
                                        echoAlert("danger", "Error", "Faied to remove the product from!");
                                }
                            }
                        ?>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <?php  
                                                echo "<a class=\"admin-panel-table-icon\" onclick=\"return confirm('Are you sure you want to remove this product from the clipboard?')\" 
