                ...
                <div class="main-content">
                    <div class="container">
                        ...
                        if(isset($_GET['name_error'])){
                            echoAlert("danger", "Error!", "Product name is required!");
                        }
                        else if(isset($_GET['add_result'])){
                            if ($_GET['add_result'] == true) {
                                echoAlert("success", "Success!", "New product added!");
                            }
                            else {
                                echoAlert("danger", "Error!", "Failed to add new product!");
                            }
                        }
                        else if(isset($_GET['del_result'])){
                            if($_GET['del_result'] == true){
                                echoAlert("success", "Success!", "Product deleted!");
                            }
                            else{
                                echoAlert("danger", "Error!", "Failed to delete product!");
                            }

                        }
                        else if(isset($_GET['update_result'])){
                            if($_GET['update_result'] == true){
                                echoAlert("success", "Success!", "Product updated!");
                            }
                            else{
                                echoAlert("danger", "Error!", "Failed to update product!");
                            }
                        }
                        if(isset($_GET['img_size_error'])){
                            echoAlert("warning", "Warning", "Image size must be less than 10MB!");
                        }    
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th class="align-middle" style="width: 5%">Product Code</th>
                                        <th class="align-middle" style="width: 15%">Product Name</th>
                                        <th class="align-middle" style="width: 15%">Description</th>
                                        <th class="align-middle" style="width: 5%">Spec</th>
                                        <th class="align-middle" style="width: 5%">UPC Image</th>                                        
                                        <th class="align-middle" style="width: 12.5%">Category</th>
                                        <!-- <th class="align-middle" style="width: 12.5%">Price</th> -->
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <?php echo $row['prod_spec']; ?>
                                        </td>      
                                        <td class="text-center align-middle">
                                            <?php 
                                                $imgPath = $row['prod_upc_img'];
                                                echo "<img class=\"img-fluid img-thumbnail\" src=\"$imgPath\">"; 
                                            ?>
                                        </td>
                                        <td class="align-middle">
                                        ...
                                        <td class="text-center align-middle">
                                            <?php 
                                                $type = "prod";     
                                                echo "<a class=\"admin-panel-table-icon\" onclick=\"return confirm('Czy na pewno chcesz usunąć ten Product?')\" 
                ...
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="admin/add_prod.php">
                        ...
                        <div class="form-group custom-file">
                            ...
                            <label class="custom-file-label" for="prodImg">Product Image (max. 10MB)</label>
                        </div>
