                    ...
                    <div class="container">
                        ...
                        <?php
                            if(isset($_GET['name_error'])){
                                echoAlert("danger", "Error!", "A category with this name already exists!");
                            }
                            else if(isset($_GET['add_result'])){
                                if ($_GET['add_result'] == true) {
                                    echoAlert("success", "Success!", "New category has been added!");
                                }
                                else {
                                    echoAlert("danger", "Error!", "Failed to add a new category!");
                                }
                            }
                            else if(isset($_GET['del_result'])){
                                if($_GET['del_result'] == true){
                                    echoAlert("success", "Success!", "Category has been deleted!");
                                }
                                else{
                                    echoAlert("danger", "Error", "Failed to delete category!"); 
                                }
                            }
                            else if(isset($_GET['update_result'])){
                                if($_GET['update_result'] == true){
                                    echoAlert("success", "Success!", "Category has been updated!");
                                }
                                else{
                                    echoAlert("danger", "Error!", "Failed to update category!");
                                }
                            }     
                        ?>
                            ...
                            <table class="table table-hover table-bordered">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th class="align-middle" style="width: 30%">Category Name</th>
                                        <th class="align-middle" style="width: 50%">Description</th>
